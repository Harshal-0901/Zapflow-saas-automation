    ...
    <main className="flex flex-col items-center justify-center mt-20">
      ...
      <div className="w-full max-w-6xl p-8">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">Email: <Link href="mailto:harshalpresswala09@gmail.com"><span className="text-blue-500 hover:underline">harshalpresswala09@gmail.com</span></Link></p>
          <p className="mb-4">Or fill out our <Link href="https://harshalpresswala.com/#contact" passHref><span className="text-blue-500 hover:underline" rel="noopener noreferrer">contact form</span></Link> and we will get back to you shortly.</p>
        </section>
