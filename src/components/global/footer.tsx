        ...
        <div>
          <div className="flex justify-center sm:justify-start space-x-6 py-2">
            <Link href="https://facebook.com"
              className="hover:text-blue-700" target='_blank'>
                <FaFacebookF size={22}/>
            </Link>
            <Link href="https://twitter.com"
              className="hover:text-blue-300" target='_blank'>
                <FaTwitter size={22}/>
            </Link>
            <Link href="https://instagram.com"
              className="hover:text-pink-500" target='_blank'>
                <FaInstagram size={22}/>
            </Link>
            <Link href="https://www.linkedin.com/in/harshal-presswala/"
              className="hover:text-blue-500" target='_blank'>
              <FaLinkedinIn size={22}/>
            </Link>
            <Link href="https://github.com/Harshal-0901"
